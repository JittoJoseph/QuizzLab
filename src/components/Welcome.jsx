		...
		<div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 flex flex-col">
				...
				<div className="w-full flex items-center space-x-12">
					...
					<div className="w-1/2 space-y-6">
						...
						<div className="flex space-x-4 pt-6">
							...
							<button className="border-2 border-blue-600 text-blue-700 px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors font-semibold">
								How It Works
							</button>
						</div>
					</div>
			...
			<footer className="bg-blue-800 text-white py-6">
				<div className="container mx-auto px-8 flex justify-between items-center">
					<p>© 2024 QuizzyAI. Powering Learning with AI.</p>
					<div className="space-x-4">
